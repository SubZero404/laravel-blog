...
{{--    <link href="https://fonts.bunny.net/css?family=Nunito" rel="stylesheet">--}}
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss','resources/js/app.js','vendor/jquery-3.6.0.js',
    'vendor/summernote/summernote.min.css','vendor/summernote/summernote-lite.min.css','vendor/summernote/summernote-lite.js'])
